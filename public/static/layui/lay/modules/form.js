                        ...
                        select: function() {
                            ...
                            f.each(function(e, l) {
                                var r = t(this),
                                    ...
                                    y = l.options[0];
                                //是否显示select边框
                                var classList = r[0].classList;
                                var haveborder = true;
                                if(Object.keys(classList).length >0)
                                {
                                    for(var i in classList){
                                        if(classList[i]=="select-style-border-none"){
                                            haveborder = false;
                                        }
                                    }
                                }
                                ...
                                var v = "string" == typeof r.attr("lay-search"),
                                    ...
                                    m = t(['<div class="' + (v ? "": "layui-unselect ") + a + (c ? " layui-select-disabled": "") + '">', '<div class="' + n + '"><input style="'+(haveborder == false?"border:none":"")+'"  type="text" placeholder="' + p + '" value="' + (d ? f.html() : "") + '" ' + (v ? "": "readonly") + ' class="layui-input' + (v ? "": " layui-unselect") + (c ? " " + u: "") + '">', '<i class="layui-edge"></i></div>', '<dl class="layui-anim layui-anim-upbit' + (r.find("optgroup")[0] ? " layui-select-group": "") + '">' +
                                    function(e) {
                                        var t = [];
                                        return layui.each(e,
                                            function(e, a) {
